  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative pt-12 pb-20 lg:pt-24 lg:pb-32 overflow-hidden bg-gray-50/50">
        <div className="absolute top-0 right-0 w-full lg:w-[45%] h-[120%] bg-gradient-to-bl from-magna-yellow/20 to-magna-green/10 rounded-l-[150px] -z-10 hidden lg:block transform -translate-y-10"></div>
        <div className="container mx-auto px-4 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center max-w-7xl">
          ...
          >
            <motion.h1 variants={itemVariants} className="text-4xl md:text-5xl lg:text-6xl font-black text-gray-900 leading-tight mb-6 relative inline-block z-10">
              <span className="relative z-10">Logbook Loans</span>
              <motion.span 
                initial={{ scaleX: 0 }} 
                animate={{ scaleX: 1 }} 
            ...
            <motion.p variants={itemVariants} className="text-xl md:text-2xl text-gray-600 font-medium mb-8">
              Very flexible approval rules for logbook loans
            </motion.p>
            
            <motion.h3 variants={itemVariants} className="text-xl font-bold text-magna-blue mb-4">Best Price Guarantee</motion.h3>
          ...
          >
            <h3 className="text-2xl font-bold text-gray-900 mb-8">Apply for a Logbook Loan</h3>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          >
            <Image src="/4.png" alt="Magna Credit Promotion" fill className="object-cover" />
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container mx-auto px-4 flex flex-col md:flex-row gap-16 items-center max-w-7xl">
          <motion.div 
            ...
            className="flex-1"
          >
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-6 leading-tight">What do I need to secure a Logbook Loan with Magna Credit?</h2>
          ...
          >
             <div className="absolute inset-0 bg-gradient-to-tr from-gray-100 to-gray-200 rounded-[3rem] overflow-hidden flex items-center justify-center shadow-xl">
                ...
                <div className="bg-magna-green/95 backdrop-blur-sm p-8 absolute bottom-8 left-8 rounded-2xl shadow-2xl border border-white/20 transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
                  <h3 className="text-3xl font-black text-white leading-tight">Enjoy Life with<br/>Lowest Monthly Payments<br/><span className="text-magna-yellow">with Magna Credit Logbook Loans</span></h3>
                </div>
             </div>
          </motion.div>
        </div>
      ...
      <section className="py-24 bg-gray-50 border-t border-b border-gray-100">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-4">Logbook Xpress loans in Uganda</h2>
          ...
          >
            {[
              { num: 1, title: "Have your own car", desc: "You have to be the owner of the vehicle and have a valid logbook." },
              { num: 2, title: "Fill in the application", desc: "Choose conditions according to your needs — select loan amount, repayment period." },
              { num: 3, title: "Sign a contract", desc: "A Magna Credit associate will contact you. Visit our Nakawa branch to sign." },
              { num: 4, title: "Get money the same day!", desc: "Receive the money instantly, continue driving your car." }
            ].map((step, i) => (
      ...
      <section className="bg-magna-blue py-20 relative overflow-hidden">
        <div className="absolute -right-20 -top-20 w-96 h-96 bg-magna-green/30 rounded-full blur-3xl opacity-50"></div>
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between max-w-7xl gap-10 relative z-10">
          ...
          >
            Get up to UGX 100M using your<br />Car Logbook
          </motion.h2>
          <motion.div
            initial={{ opacity: 0, scale: 0.9 }}
            whileInView={{ opacity: 1, scale: 1 }}
            viewport={{ once: true }}
          >
            <Link href="/contacts" className="bg-magna-green hover:bg-green-600 text-white px-12 py-5 rounded-full font-bold text-xl transition-transform hover:scale-105 whitespace-nowrap shadow-2xl shadow-magna-green/50 inline-block">
              Apply Now
            </Link>
          </motion.div>
        </div>
